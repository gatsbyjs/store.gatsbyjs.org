    ...
    return (
      <ShippingInfoRoot className={detailsVisible ? 'expanded' : ''}>
        <Intro role="button" onClick={this.toggle}>
          ...
          be delivered and may be subject to <a href="https://github.com/gatsbyjs/store.gatsbyjs.org#frequently-asked-questions" target="blank" rel="nofollow">local taxes and duties. </a> <ArrowIcon />
        </Intro>
        <Details>
